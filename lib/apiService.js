...
// Resolved from env via lib/constants.js (NEXT_PUBLIC_API_URL / NEXT_PUBLIC_APP_ENV)
const API_BASE_URL = constants.apiUrl;
...
const convertVideoToPdf = async (
  ...
  if (
    ...
    throw new ApiError(
      "Time interval must be a number between 1 and 3600 seconds",
      400
    );
  }
  ...
  try {
    ...
    // Backend expects time_interval in seconds
